MetronicApp.controller('RoleAddController', ['$rootScope', '$scope','$http','$state','$stateParams','settings', function($rootScope, $scope,$http,$state,$stateParams, settings) {
