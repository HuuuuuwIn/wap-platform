    ...
    var l = function (e) {
        ...
        g.prototype = {
            fnRowToPixels: function (a, b, c) {
                ...
                0 > h && (h = 0);
                if ((f > this.s.redrawBottom || f < this.s.redrawTop) && this.s.dt._iDisplayStart !== h)d = !0, f = this.fnRowToPixels(a, !1, !0);
                ...
                if (!this.s.skip && !this.s.ingnoreScroll)if (this.s.dt.bFiltered || this.s.dt.bSorted)this.s.lastScrollTop = 0; else {
                    ...
                    if (c < this.s.redrawTop || c > this.s.redrawBottom) {
                        ...
                        if (d != this.s.dt._iDisplayStart && (this.s.tableTop = e(this.s.dt.nTable).offset().top, this.s.tableBottom = e(this.s.dt.nTable).height() + this.s.tableTop, b = function () {
                            ...
                            }, this.s.dt.oFeatures.bServerSide ? (clearTimeout(this.s.drawTO), this.s.drawTO = setTimeout(b, this.s.serverWait)) : b(), this.dom.loader && !this.s.loaderVisible))this.dom.loader.css("display",
    ...
    n = function (b) {
        ...
        f.prototype = {
            fnReset: function () {
                ...
                var c =
                    this, d = b(a.target).closest("th, td").offset(), f = parseInt(b(e).attr("data-column-index"), 10);
    ...
    var attach = function (container, buttons) {
        ...
        var clickHandler = function (e) {
            ...
            if (e.data.action !== 'ellipsis') {
            	sessionStorage.setItem('change_page',1);
