...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _readFiles: function (files) {
            ...
            //add by huy
            var fileSize = ((files[0].size || 0) / 1000).toFixed(2);
            if (self.maxFileSize > 0 && fileSize > self.maxFileSize) {
            	zzcmAlert("文件大于"+self.maxFileSize+"KB");
                self.$caption.attr('title', "文件大于"+self.maxFileSize+"KB");
            }
            //end
        },
    ...
    $.fn.fileinputLocales.zh = {
        ...
        msgFilesTooLess: '你必须选择最少 <b>{n}</b> 个文件来上传. ',
