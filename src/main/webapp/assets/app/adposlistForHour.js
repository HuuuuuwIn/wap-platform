var AdposListForHour = function () {
	
    var initTable = function (d,v) {
        var table = $('#sampleAdposForHour');
        ...
        var tableColumnToggler = $('#sampleAdposForHour_column_toggler');

        var tableWrapper = $('#sampleAdposForHour_wrapper');
