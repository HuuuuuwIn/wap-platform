MetronicApp.directive('sitehourTable', function() {
    return {
        restrict: 'A',
        link: function(scope, elem, attrs) {
			...
			var tableColumnToggler = $('#sitehourTable_column_toggler');
			var tableWrapper = $('#sitehourTable_wrapper'); // datatable creates the table wrapper by adding with id {your_table_jd}_wrapper
